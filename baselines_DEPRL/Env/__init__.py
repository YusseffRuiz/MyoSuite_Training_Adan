...
amputationModel_new = '/../../../simhive/myo_sim/AmputationModel/TP_model_myosuite.xml'
#amputationModel_new = '/../../../simhive/myo_sim/AmputationModel/lOSL_TFA_L_Ankle_Modified_cvt3.xml'
...
register_env_with_variants(id='myoLegWalk-v0',
        ...
        kwargs={
            ...
            'target_y_vel':0.5,  # desired y velocity in m/s
            'target_rot': None   # if None then the initial root pos will be taken, otherwise provide quat
        }
    )
# Modified Amputee Walking ==============================
register_env_with_variants(id='myoAmpWalk-v0',
        entry_point='myosuite.envs.myo.myobase.walk_v1:WalkEnvV0',
        max_episode_steps=1000,
        kwargs={
            'model_path' : curr_dir + amputationModel_new,
            'normalize_act': True,
            'min_height':0.8,    # minimum center of mass height before reset
            'max_rot':0.8,       # maximum rotation before reset
            'hip_period':100,    # desired periodic hip angle movement
