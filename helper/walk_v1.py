...
class WalkEnvV0(BaseV0):
    ...
    def get_obs_dict(self, sim):
        ...
        obs_dict["qpos_without_xy"] = sim.data.qpos[:].copy()  ### qpos[2:] original
    ...
    def get_randomized_initial_state(self):
        ...
        if self.np_random.uniform() < 0.5:
            qpos = self.sim.model.key_qpos[0].copy()  ## modified from 2
            qvel = self.sim.model.key_qvel[0].copy()  ## modified from 2
        else:
            qpos = self.sim.model.key_qpos[0].copy()  #### modified from 3
            qvel = self.sim.model.key_qvel[0].copy()  ##### modified from 3
    ...
    def _get_feet_heights(self):
        ...
        """
        foot_id_l = self.sim.model.body_name2id("AnkleAssembly")
