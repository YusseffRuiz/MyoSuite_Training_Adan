...
class MJRenderer(Renderer):
    ...
    def _update_viewer_settings(self, viewer):
        ...
        """Update contact point and contact force in the viewer"""
        viewer.flags[mujoco.mjtVisFlag.mjVIS_CONTACTPOINT] = True # mjVIS_CONTACTPOINT
        viewer.flags[mujoco.mjtVisFlag.mjVIS_CONTACTFORCE] = True # mjVIS_CONTACTFORCE
        viewer.flags[mujoco.mjtVisFlag.mjVIS_TRANSPARENT] = False
        viewer.flags[mujoco.mjtVisFlag.mjVIS_PERTFORCE] = True
        #viewer.flags[mujoco.mjtVisFlag.mjVIS_COM] = True # mjVIS_COM
        # got from https://mujoco.readthedocs.io/en/stable/APIreference/APItypes.html
